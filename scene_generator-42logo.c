...
t_vec3	random_pos_in_rectangle(double x_min, double x_max, double z_min, double z_max)
{
	t_vec3	vec3;
...
t_vec3	random_pos_in_triangle(double x_min, double x_max, double z_min, double z_max, int side)
{
	t_vec3	vec3;
...
t_sphere gen_sphere_in_rectangle(t_sphere *spheres, int sphere_count, double x_min, double x_max, double z_min, double z_max)
{
	int 		i;
	t_sphere	tmp;

	tmp.pos = random_pos_in_rectangle(x_min, x_max, z_min, z_max);
...
t_sphere gen_sphere_in_triangle(t_sphere *spheres, int sphere_count, double x_min, double x_max, double z_min, double z_max, int side)
{
	int 		i;
	t_sphere	tmp;

	tmp.pos = random_pos_in_triangle(x_min, x_max, z_min, z_max, side);
	tmp.radius = tmp.pos.y;
	i = 0;
	while (i < sphere_count)
	{
...
int	main(int argc, char *argv[])
{
	...
	printf("## SAMPLING ###########################################################################################################\n# | samples  | bounces | cos sampling   | light sampling | ############################################################\n#######################################################################################################################\n");
	printf("S   1000       50        1.00             0.00\n\n");
	...
	{
		spheres[i] = gen_sphere_in_rectangle(spheres, i, 10, 15, -5, 0);
		i++;
		j++;
	}
	...
	while (j < SPHERES_SQUARE)
	{
		spheres[i] = gen_sphere_in_rectangle(spheres, i, 0, 5, -10, -5);
		i++;
		j++;
	}
	...
	while (j < SPHERES_SQUARE)
	{
		spheres[i] = gen_sphere_in_rectangle(spheres, i, 5, 10, -10, -5);
		i++;
		j++;
	}
	j = 0;
	while (j < SPHERES_SQUARE)
	{
		spheres[i] = gen_sphere_in_rectangle(spheres, i, 10, 15, -10, -5);
		i++;
		j++;
	}
	...
	{
		spheres[i] = gen_sphere_in_triangle(spheres, i, 0, 5, -15, -10, BOTTOM);
		i++;
		j++;
	}
	...
	while (j < SPHERES_TRIANGLE)
	{
		spheres[i] = gen_sphere_in_triangle(spheres, i, 5, 10, -15, -10, TOP);
		i++;
		j++;
	}
	...
	while (j < SPHERES_TRIANGLE)
	{
		spheres[i] = gen_sphere_in_triangle(spheres, i, 5, 10, -20, -15, BOTTOM);
		i++;
		j++;
	}
	...
	while (j < SPHERES_TRIANGLE)
	{
		spheres[i] = gen_sphere_in_triangle(spheres, i, 10, 15, -20, -15, TOP);
		i++;
		j++;
	}
	...
	while (j < SPHERES_SQUARE)
	{
		spheres[i] = gen_sphere_in_rectangle(spheres, i, 17, 22, -10, -5);
		i++;
		j++;
	}
	...
	while (j < SPHERES_TRIANGLE)
	{
		spheres[i] = gen_sphere_in_triangle(spheres, i, 22, 27, -10, -5, BOTTOM);
		i++;
		j++;
	}
	...
	while (j < SPHERES_TRIANGLE)
	{
		spheres[i] = gen_sphere_in_triangle(spheres, i, 17, 22, -15, -10, BOTTOM);
		i++;
		j++;
	}
	...
	while (j < SPHERES_TRIANGLE)
	{
		spheres[i] = gen_sphere_in_triangle(spheres, i, 22, 27, -15, -10, TOP);
		i++;
		j++;
	}
	...
	while (j < SPHERES_TRIANGLE)
	{
		spheres[i] = gen_sphere_in_triangle(spheres, i, 17, 22, -20, -15, TOP);
		i++;
		j++;
	}
	...
	while (j < SPHERES_SQUARE)
	{
		spheres[i] = gen_sphere_in_rectangle(spheres, i, 22, 27, -20, -15);
		i++;
		j++;
	}
