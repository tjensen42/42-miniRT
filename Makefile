...
#    Updated: 2022/05/18 12:56:21 by hepple           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_PARSE		:= mrt_parse_cam.c mrt_parse_material.c mrt_parse_obj_cuboid.c mrt_parse_obj_sphere.c mrt_parse_scene.c mrt_parse_obj_rectangle.c \
...
SRCS_PRINT		:= mrt_print_error.c mrt_print_is.c mrt_print_obj_plane.c mrt_print_obj_rectangle.c mrt_print_scene.c \
