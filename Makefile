...
#    Updated: 2022/06/06 11:44:22 by tjensen          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			:= main.c mrt_color.c mrt_obj.c mrt_obj_textures.c mrt_scene.c mrt_light.c
SRCS_GRAPHIC	:= mrt_graphic_render.c
SRCS_MATH		:= mrt_math_color.c mrt_math_vec3_1.c mrt_math_vec3_2.c
SRCS_PARSE		:= mrt_parse_cam.c mrt_parse_texture.c mrt_parse_material.c mrt_parse_obj_cuboid.c mrt_parse_obj_tube.c mrt_parse_obj_disc.c mrt_parse_obj_sphere.c mrt_parse_scene.c mrt_parse_obj_rectangle.c \
